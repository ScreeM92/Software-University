...
intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function() {
    /// <signature>
    ///   <summary>Creates an object that handles the actual transmission of Ajax bookShopData.</summary>
    ///   <param name="dataType" type="String">A string identifying the bookShopData type to use</param>
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new transport object to use with the bookShopData type provided in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Returns value at named bookShopData store for the element, as set by jQuery.bookShopData(element, name, value), or the full bookShopData store for the element.</summary>
    ///   <param name="element" type="Element">The DOM element to query for the bookShopData.</param>
    ///   <param name="key" type="String">Name of the bookShopData stored.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Returns value at named bookShopData store for the element, as set by jQuery.bookShopData(element, name, value), or the full bookShopData store for the element.</summary>
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Load bookShopData from the server using a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="bookShopData" type="String">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(bookShopData, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of bookShopData expected from the server. Default: Intelligent Guess (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
    /// <signature>
    ///   <summary>Load JSON-encoded bookShopData from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="bookShopData" type="PlainObject">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(bookShopData, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'hasData': function() {
    /// <signature>
    ///   <summary>Determine whether an element has any jQuery bookShopData associated with it.</summary>
    ///   <param name="element" type="Element">A DOM element to be checked for bookShopData.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'holdReady': function() {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="bookShopData" type="String">HTML string to be parsed</param>
  ...
  'parseXML': function() {
    ...
    ///   <param name="bookShopData" type="String">a well-formed XML string to be parsed</param>
    ///   <returns type="XMLDocument" />
    /// </signature>
  },
  'post': function() {
    /// <signature>
    ///   <summary>Load bookShopData from the server using a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="bookShopData" type="String">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(bookShopData, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of bookShopData expected from the server. Default: Intelligent Guess (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of bookShopData.</summary>
    ///   <param name="element" type="Element">A DOM element from which to remove bookShopData.</param>
    ///   <param name="name" type="String">A string naming the piece of bookShopData to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'data': function() {
    /// <summary>An optional object of bookShopData passed to an event method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'attributeContains': function() {
    ...
    ///   <param name="value" type="String">An attribute value. Can be either an unquoted single search or a quoted string.</param>
    /// </signature>
  },
  ...
  'attributeContainsWord': function() {
    /// <signature>
    ///   <summary>Selects elements that have the specified attribute with a value containing a given search, delimited by spaces.</summary>
    ///   <param name="attribute" type="String">An attribute name.</param>
    ///   <param name="value" type="String">An attribute value. Can be either an unquoted single search or a quoted string.</param>
    /// </signature>
  },
  ...
  'bind': function() {
    ...
    ///   <param name="eventData" type="Object">An object containing bookShopData that will be passed to the event handler.</param>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers should be copied along with the elements. As of jQuery 1.4, element bookShopData will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and bookShopData should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and bookShopData for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Store arbitrary bookShopData associated with the matched elements.</summary>
    ///   <param name="key" type="String">A string naming the piece of bookShopData to set.</param>
    ///   <param name="value" type="Object">The new bookShopData value; it can be any Javascript type including Array or Object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Store arbitrary bookShopData associated with the matched elements.</summary>
    ///   <param name="obj" type="Object">An object of key-value pairs of bookShopData to update.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dblclick': function() {
  ...
  'keydown': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "keydown" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="eventData" type="PlainObject">An object containing bookShopData that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'live': function() {
    ...
    ///   <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names.</param>
    ///   <param name="bookShopData" type="PlainObject">An object containing bookShopData that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'on': function() {
    ...
    ///   <param name="bookShopData" type="Anything">bookShopData to be passed to the handler in event.bookShopData when an event is triggered.</param>
    ...
    ///   <param name="bookShopData" type="Anything">bookShopData to be passed to the handler in event.bookShopData when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of bookShopData.</summary>
    ///   <param name="name" type="String">A string naming the piece of bookShopData to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored piece of bookShopData.</summary>
    ///   <param name="list" type="String">An array or space-separated string naming the pieces of bookShopData to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeProp': function() {
  ...
  'unload': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "unload" JavaScript event.</summary>
    ///   <param name="eventData" type="Object">A plain object of bookShopData that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
